...
dockets_confinement <- dispositions %>% 
  ...
  filter(!(str_detect(max_period_parsed, "time_served") & is.na(credit))) %>% 
  filter(max_period_parsed != "other") %>% 
  filter(max_period_parsed != "death penalty imposed") %>% 
